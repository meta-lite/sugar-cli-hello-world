...
* [Phantom](https://phantom.app/) - Generate a fresh instance of Phantom Wallet in your preffered browser.
...
* Our candy machine is now active on Devnet! To mint the first NFT, run ```sugar mint``` or to mint the enire collection run ```sugar mint -n 10``` with 10 being the number of NFT's in the collection.
